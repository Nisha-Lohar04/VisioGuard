...
1. 🎥 Analyze the incoming video stream
2. 🔍 Perform AI-based object and anomaly detection
3. 👊 Analyze suspicious or violent activity
4. 🚨 Generate alerts for detected incidents
5. 📸 Capture supporting visual evidence
6. 🗂️ Store event information and historical records
7. 📊 Display monitoring information through a centralized dashboard
...
This project has been associated with research work in the areas of:
...
> 📌 Research publication details can be added here if publicly available and safe to disclose.
